...
if __name__ == '__main__':
    ...
    parser.add_argument('--filename', help = 'name of output file', type = str, default = 'eps=1e-4_true')
    ...
    for k in KSet:
        ...
        train = readtruth(dest+'/pathway_origin/train')

        pred_train = pred.difference(train)
        remain_train = truth.difference(train)
